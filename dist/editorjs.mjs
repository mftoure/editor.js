...
const C = Ee.bind(window, !1), X = Ee.bind(window, !0);
function ne(n) {
...
function Ho(n, e) {
  ...
  return A(t) ? t(n) : Q(t) ? n[t] : (t !== void 0 && C("Conversion «export» property must be a string or function. String means key of saved data object to export. Function should export processed string to export."), "");
}
function wt(n, e) {
...
`);
      ...
      function _(v) {
        ...
        return v.attrs.type === void 0 && (v.attrs.type = "text/css"), ee(m, v.attrs), S(v, m), m;
      }
      function ee(v, m) {
      ...
      function j(v, m) {
        ...
        if (m.singleton) {
          ...
          v.sourceMap && typeof URL == "function" && typeof URL.createObjectURL == "function" && typeof URL.revokeObjectURL == "function" && typeof Blob == "function" && typeof btoa == "function" ? (x = function(B) {
            ...
            return B.attrs.type === void 0 && (B.attrs.type = "text/css"), B.attrs.rel = "stylesheet", ee(Y, B.attrs), S(B, Y), Y;
          }(m), E = (function(B, Y, fe) {
...
`);
      ...
      t.exports = (s = "cdx-notifies", r = "cdx-notify", l = "cdx-notify__cross", a = "cdx-notify__button--confirm", c = "cdx-notify__button--cancel", u = "cdx-notify__input", h = "cdx-notify__button", p = "cdx-notify__btns-wrapper", { alert: g = function(f) {
        var k = document.createElement("DIV"), S = document.createElement("DIV"), I = f.message, _ = f.style;
        return k.classList.add(r), _ && k.classList.add(r + "--" + _), k.innerHTML = I, S.classList.add(l), S.addEventListener("click", k.remove.bind(k)), k.appendChild(S), k;
      }, confirm: function(f) {
        var k = g(f), S = document.createElement("div"), I = document.createElement("button"), _ = document.createElement("button"), ee = k.querySelector("." + l), j = f.cancelHandler, $ = f.okHandler;
        return S.classList.add(p), I.innerHTML = f.okText || "Confirm", _.innerHTML = f.cancelText || "Cancel", I.classList.add(h), _.classList.add(h), I.classList.add(a), _.classList.add(c), j && typeof j == "function" && (_.addEventListener("click", j), ee.addEventListener("click", j)), $ && typeof $ == "function" && I.addEventListener("click", $), I.addEventListener("click", k.remove.bind(k)), _.addEventListener("click", k.remove.bind(k)), S.appendChild(I), S.appendChild(_), k.appendChild(S), k;
      }, prompt: function(f) {
        var k = g(f), S = document.createElement("div"), I = document.createElement("button"), _ = document.createElement("input"), ee = k.querySelector("." + l), j = f.cancelHandler, $ = f.okHandler;
        return S.classList.add(p), I.innerHTML = f.okText || "Ok", I.classList.add(h), I.classList.add(a), _.classList.add(u), f.placeholder && _.setAttribute("placeholder", f.placeholder), f.default && (_.value = f.default), f.inputType && (_.type = f.inputType), j && typeof j == "function" && ee.addEventListener("click", j), $ && typeof $ == "function" && I.addEventListener("click", function() {
          $(_.value);
        }), I.addEventListener("click", k.remove.bind(k)), S.appendChild(_), S.appendChild(I), k.appendChild(S), k;
      }, getWrapper: function() {
    ...
    t.prototype.clean = function(h) {
      ...
      if (f)
        do {
          ...
          var I = !!p.parentNode, _ = i(p) && i(f) && I, ee = f.nodeName.toLowerCase(), j = a(this.config, ee, f), $ = k && S;
...
class Pi extends y {
  ...
  get methods() {
    return {
      ...
      updateToolConfig: (e, t) => this.updateToolConfig(e, t)
    };
  }
  updateToolConfig(e, t) {
    const o = this.Editor.Tools.available.get(e);
    o ? o.updateConfig(t) : C(`Incorrect toolName: ${e}`);
  }
}
class Di extends y {
  /**
...
class ct {
   ...
   */
  updateConfig(e) {
    this.config && (this.config.config = e);
  }
  /**
    ...
    for (let s = 0; s < o.length; s++) {
      ...
      [a].flat().forEach((p) => {
        ...
        if (d.isElement(p)) {
          ...
          "children" in S && s !== 0 && i.push({
            type: O.Separator
          }), i.push(S), "children" in S && s < o.length - 1 && i.push({
            type: O.Separator
          });
        }
      });
...
const ro = class lo extends y {
  ...
  getFilesConfig(e) {
    ...
    !o && !i || (o && !Array.isArray(o) && (C(`«extensions» property of the onDrop config for «${e.name}» Tool should be an array`), o = []), i && !Array.isArray(i) && (C(`«mimeTypes» property of the onDrop config for «${e.name}» Tool should be an array`), i = []), i && (i = i.filter((s) => To(s) ? !0 : (C(`MIME type value «${s}» for the «${e.name}» Tool is not a valid MIME type`, "warn"), !1))), this.toolsFiles[e.name] = {
      extensions: o || [],
      mimeTypes: i || []
    });
  }
  ...
  processHTML(e) {
    ...
    return o.innerHTML = e, this.getNodes(o).map((s) => {
      ...
      const { tags: c } = l.pasteConfig || { tags: [] }, u = c.reduce((g, f) => (this.collectTagNames(f).forEach((S) => {
        const I = R(f) ? f[S] : null;
        g[S.toLowerCase()] = I || {};
